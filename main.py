...
# Eco-friendly and harmful materials list
...
# Product-specific eco-friendly alternatives (Real Market Alternatives)
ECO_ALTERNATIVES = {
...
def calculate_eco_score(packaging, ingredients):
    """Calculate an eco-friendliness score based on packaging and ingredients."""
    ...
    return max(1, min(score, 10))  # Ensure score stays between 1 and 10

def get_eco_score_explanation(score):
    """Provide an explanation for the eco-score."""
    if score >= 8:
...
def get_product(
    ...
    """Fetch product details and return eco-score, or allow user input if product is not found."""
